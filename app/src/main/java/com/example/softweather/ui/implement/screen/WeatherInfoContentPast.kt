...
import com.example.softweather.ui.implement.screen.WeatherDayItem
import com.example.softweather.ui.implement.screen.WeatherDetailRow
import com.example.softweather.ui.implement.screen.WeatherHourItem
import com.example.softweather.ui.implement.screen.WeatherMergedModel
...
fun WeatherInfoContentPast(
    ...
    val averTemp = temperatureHourly.take(12).sum()/12
    val averHumidity = humidityList.take(12).sum()/12
    ...
    Column(
        ...
        Column(
            ...
            WeatherDetailRow("일출/일몰", "${DateConverter(sunriseList[0]?:"누락", useHour = true, useMin =  true)} / ${sunsetText}${DateConverter(sunsetList[0]?:"누락", useHour = true, useMin = true)}")
        ...
        LazyRow(
            ...
            items(utilHourlyList.take(26)) { hourly ->
                ...
                WeatherHourItem(hourly, weatherCodeHourly.getOrNull(hIdx)?:120, temperatureHourly.getOrNull(hIdx)?:99.0)
            }
        }
